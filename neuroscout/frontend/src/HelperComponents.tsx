...
export const MainCol: React.FC<{}> = (children) => {
  return (
      <Col
          xxl={{ span: 16 }}
          xl={{ span: 18 }}
...
export class DisplayErrorsInline extends React.Component<
{ errors: string[] },
{}
> {
    render() {
...
export class NotFound extends React.Component<Record<string, never>, Record<string, never>> {
    render() {
